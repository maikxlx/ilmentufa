...
m = expr:(comma* [mM] !h !glide !m !z !s) {return _node("m", expr);}
...
CAhA = expr:(&cmavo ( c a h a / p u h i / n u h o / k a h e ) &post_word) {return _node("CAhA", expr);}
...
COI = expr:(&cmavo ( j u h i / c o i / f i h i / t a h a / m u h o / f e h o / c o h o / p e h u / k e h o / n u h e / r e h i / b e h e / j e h e / m i h e / k i h e / v i h o ) &post_word) {return _node("COI", expr);}
...
LA = expr:(&cmavo ( l a i / l a h i / l a ) &post_word) {return _node("LA", expr);}

LAU = expr:(&cmavo ( c e h a / l a u / z a i / t a u ) &post_word) {return _node("LAU", expr);}

LAhE = expr:(&cmavo ( t u h a / l u h a / l u h o / l a h e / v u h i / l u h i / l u h e ) &post_word) {return _node("LAhE", expr);}

LE = expr:(&cmavo ( l e i / l o i / l e h i / l o h i / l e h e / l o h e / l o / l e ) &post_word) {return _node("LE", expr);}
...
MAI = expr:(&cmavo ( m o h o / m a i ) &post_word) {return _node("MAI", expr);}

ME = expr:(&cmavo ( m e ) &post_word) {return _node("ME", expr);}
...
NAI = expr:(&cmavo ( n a i ) &post_word) {return _node("NAI", expr);}

NAhE = expr:(&cmavo ( t o h e / j e h a / n a h e / n o h e ) &post_word) {return _node("NAhE", expr);}

NAhU = expr:(&cmavo ( n a h u ) &post_word) {return _node("NAhU", expr);}
...
NU = expr:(&cmavo ( n i / d u h u / s i h o / n u / l i h i / k a / j e i / s u h u / z u h o / m u h e / p u h u / z a h i ) &post_word) {return _node("NU", expr);}
...
ROI = expr:(&cmavo ( r e h u / r o i ) &post_word) {return _node("ROI", expr);}
...
SI = expr:(&cmavo ( s i ) &post_word) {return _node("SI", expr);}
...
UI = expr:(&cmavo ( i h a / i e / a h e / u h i / i h o / i h e / a h a / i a / o h i / o h e / e h e / o i / u o / e h i / u h o / a u / u a / a h i / i h u / i i / u h a / u i / a h o / a i / a h u / i u / e i / o h o / e h a / u u / o h a / o h u / u h u / e h o / i o / e h u / u e / i h i / u h e / b a h a / j a h o / c a h e / s u h a / t i h e / k a h u / s e h o / z a h a / p e h i / r u h a / j u h a / t a h o / r a h u / l i h a / b a h u / m u h a / d o h a / t o h u / v a h i / p a h e / z u h u / s a h e / l a h a / k e h u / s a h u / d a h i / j e h u / s a h a / k a u / t a h u / n a h i / j o h a / b i h u / l i h o / p a u / m i h u / k u h i / j i h a / s i h a / p o h o / p e h a / r o h i / r o h e / r o h o / r o h u / r o h a / r e h e / l e h o / j u h o / f u h i / d a i / g a h i / z o h o / b e h u / r i h e / s e h i / s e h a / v u h e / k i h a / x u / g e h e / b u h o ) &post_word) {return _node("UI", expr);}
...
ZAhO = expr:(&cmavo ( c o h i / p u h o / c o h u / m o h u / c a h o / c o h a / d e h a / b a h o / d i h a / z a h o ) &post_word) {return _node("ZAhO", expr);}
...
ZO = expr:(&cmavo ( z o ) &post_word) {return _node("ZO", expr);}
